...
// ExecQueryRows mocks base method.
func (m *MockPGX) ExecQueryRows(ctx context.Context, query string, args ...interface{}) (pgx.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "ExecQueryRows", varargs...)
	ret0, _ := ret[0].(pgx.Rows)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ExecQueryRows indicates an expected call of ExecQueryRows.
func (mr *MockPGXMockRecorder) ExecQueryRows(ctx, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, query}, args...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecQueryRows", reflect.TypeOf((*MockPGX)(nil).ExecQueryRows), varargs...)
}
...
// ExecQueryRows mocks base method.
func (m *MockDBops) ExecQueryRows(ctx context.Context, query string, args ...interface{}) (pgx.Rows, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{ctx, query}
	for _, a := range args {
		varargs = append(varargs, a)
...
// ExecQueryRows indicates an expected call of ExecQueryRows.
func (mr *MockDBopsMockRecorder) ExecQueryRows(ctx, query interface{}, args ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{ctx, query}, args...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecQueryRows", reflect.TypeOf((*MockDBops)(nil).ExecQueryRows), varargs...)
}
